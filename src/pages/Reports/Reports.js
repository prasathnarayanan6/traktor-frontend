                        ...
                        <div className="grid grid-cols-3 gap-4 m-1">
                            <div className="p-4 border">
                                ...
                                <div className="grid grid-cols-3 gap-4 p-4">
                                    <button type="button" className="border border-green-400 px-1 py-1 rounded-md hover:bg-green-100" onClick={handleActive}><span className="flex justify-center items-center">{tick && <FaCheck className="mr-1" />}</span><span>{tick === false && (<span>Active</span>)}</span></button>
                                    <button type="button" className="border border-blue-600 px-1 py-2 rounded-md hover:bg-blue-100 text-center" onClick={handleGraduated}><span className="flex justify-center items-center">{graduated && <FaCheck className="mr-1" />}</span><span>{graduated === false && (<span>Graduate</span>)}</span></button>
                                    <button type="button" className="border border-red-600 px-1 py-1 rounded-md hover:bg-red-100" onClick={handleDropped}><span className="flex justify-center items-center">{dropped && <FaCheck className="mr-1" />}</span><span>{dropped === false && (<span>Dropped</span>)}</span></button>
                                </div><br></br>
                                <div className="">
